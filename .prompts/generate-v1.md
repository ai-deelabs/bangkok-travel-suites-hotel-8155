...
Full-bleed horizontal scroll with pinned room-preview panels and a floating nav ribbon — Condensed grotesque headers (tight tracking, all-caps) paired with light mono captions — Duotone: warm ivory #F5EFE4 dominant canvas + deep lacquer red #9B1B30 as the single accent (reference: 1970s Thai cinema lobby cards) — Cinematic, authoritative, slow-burn luxury
