...
Brand:
Bangkok Travel Suites Hotel is a hotel offering spacious, contemporary rooms with Thai hospitality. It's located on Ngamwongwan Road. The desired style for the new website is modern, clean, and warm.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Asymmetric split-screen with a live-tinted room image occupying 65% left and a narrow right column holding stacked room-type cards that slide vertically on scroll — Humanist sans for UI elements + expressive Thai-influenced calligraphic display font for headlines — Electric pairing: near-black charcoal #171412 canvas + phosphor mint #00FFB3 accent + warm parchment #E8DFC8 for body panels (reference: Vaporwave/Lo-fi aesthetics colliding with traditional Thai manuscript illumination) — Nocturnal, contemporary, surprising warmth
